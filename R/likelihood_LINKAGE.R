...
likelihood_LINKAGE = function (x, marker, theta = NULL, afreq = NULL, logbase = NULL, 
                           TR.MATR = NULL, initialCalc = NULL, singleNum.geno = NULL, loop_breakers = NULL) {
    ...
    if (is.null(singleNum.geno)) {
        ...
        if (attr(marker, 'nalleles') > 4) stop("Marker has more than 4 alleles. You should use 'likelihood()' instead.")
